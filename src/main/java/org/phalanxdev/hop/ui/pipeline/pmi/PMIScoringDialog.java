...
import org.phalanxdev.hop.pipeline.transforms.pmi.PMIScoringClusterer;
 ...
 * @version $Revision: $
 */
public class PMIScoringDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  public String open() {
    ...
    m_stepnameText.setText( transformName );
  ...
  private void ok() {
    if ( org.apache.hop.core.util.Utils.isEmpty( m_stepnameText.getText() ) ) {
      return;
    }

    transformName = m_stepnameText.getText(); // return value
    ...
    if ( !org.apache.hop.core.util.Utils.isEmpty( m_wFilename.getText() ) && !m_inputMeta.getStoreModelInStepMetaData() ) {
    ...
    if ( !org.apache.hop.core.util.Utils.isEmpty( m_wAcceptFileNameFromFieldText.getText() ) ) {
    ...
    if ( m_inputMeta.getUpdateIncrementalModel() ) {
      if ( !org.apache.hop.core.util.Utils.isEmpty( m_wSaveFilename.getText() ) ) {
    ...
    if ( !org.apache.hop.core.util.Utils.isEmpty( m_batchScoringBatchSizeText.getText() ) ) {
  ...
  public void getData() {
    if ( m_inputMeta.getFileNameFromField() ) {
      ...
      if ( !org.apache.hop.core.util.Utils.isEmpty( m_inputMeta.getFieldNameToLoadModelFrom() ) ) {
    ...
    if ( !org.apache.hop.core.util.Utils.isEmpty( m_inputMeta.getBatchScoringSize() ) ) {
